...
import 'package:Covid_Norge/services/sharedPrefrences.dart';
    ...
    if (result != null) {
      return ListView(
        children: <Widget>[
          ...
          SwitchListTile(
            title: Text("Vestfold og Telemark"),
